  ...
  const buscarDadoSelecionado = async (uid) => {
    try {
      ...
      if (dadoEspecifico.exists()) {
        ...
        //todo fazer um container  que exiba os dados selecionados, adicionar um campo de data que não é mapeado na tabela, nos próximos exercicios iremos adicionar os botões de excluir e alterar aqui
        return;
      }
